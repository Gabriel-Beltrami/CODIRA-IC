...
subroutine write_vtk(T,b)
	...
	real(KIND = DP), dimension(Nx,itermax) :: T
	...
	write ( 1,'(f22.14)' ) 1.0
	write ( 1,'(a13,1i4,a6)' ) 'COEFFICIENTS_ae',nx,' float'
	write ( 1,'(f22.14)' ) (ae(i),i=1,nx)
	write ( 1,'(a13,1i4,a6)' ) 'COEFFICIENTS_aw',nx,' float'
	write ( 1,'(f22.14)' ) (aw(i),i=1,nx)
	write ( 1,'(a13,1i4,a6)' ) 'COEFFICIENTS_ap',nx,' float'
	write ( 1,'(f22.14)' ) (ap(i),i=1,nx)
	write ( 1,'(a13,1i4,a6)' ) 'COEFFICIENTS_b',nx,' float'
	...
	write ( 1, '(f22.14)' ) ((T(i,j),i=1,(nx)),j=1,(itermax))
