...
!!    @brief   Module containing all the subprograms related to grid tools.
!!    @authors Jan Mateu
!!    @date    22/08/2017
!--------------------------------------------------------------------------------------------------
module grids
...
!--------------------------------------------------------------------------------------------------
!     SUBROUTINE Grid 2D
!>    @brief     2D rectangular structured mesh refined in the boundaries by a tangent function, the refined is controlled by.
!!    @authors   Jan Mateu
!!    @date      22/08/2017  
!!    @param     [in] Filling.
!!    @param     [out] Filling.
